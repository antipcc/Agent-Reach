...
| 📱 **SMS / httpSMS** | Read SMS threads · find verification codes | API key | Your own Android phone as the gateway ([httpSMS](https://github.com/NdoleStudio/httpsms), MIT, self-hostable). Read-only — Agent Reach never sends SMS |
